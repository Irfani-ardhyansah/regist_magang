      ...
      <div class="modal-body">
        <form action="{{ url('/home/update/'. $row->id ) }}" method="POST">
          ...
          <label class="col-sm-2 col-form-label">Periode Mulai</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="periode_mulai" value="{{$row->periode_mulai}}" required>
            </div>
          </div>
          <div class="form-group row mt-3">
          <label class="col-sm-2 col-form-label">Periode Akhir</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="periode_akhir" value="{{$row->periode_akhir}}" required>
            </div>
          </div>
            <div class="form-group row mt-3">
